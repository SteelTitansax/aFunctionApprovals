...
def aFunctionApprovals(req: func.HttpRequest) -> func.HttpResponse:
    ...
    def graph_auth ():
        ...
        app_id = '--------------------------------------'  # Application Id - on the azure app overview page
        client_secret = '-----------------------------------'  # SecretValue Id
        tenantId = '------------------------------------'  # Tenant Id of Azure Suscription
    ...
    try:
        ...
        adaptative_card_json = adaptative_card_json.replace('{TextTravelNumberValue}',  travelApproverUserPrincipalName)
